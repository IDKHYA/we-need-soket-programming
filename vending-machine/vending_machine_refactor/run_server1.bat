...
"%PYTHON_EXE%" -m vending_machine.server.runner --server-id server1 --database-url sqlite:///./data/server/server1.db --peer-server-id server2 --peer-sync-host 127.0.0.1 --peer-sync-port 9102 --sync-host 127.0.0.1 --sync-port 9101 --host 127.0.0.1 --port 8001
pause
